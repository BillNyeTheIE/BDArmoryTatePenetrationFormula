    ...
    public class MissileLauncher : MissileBase, IPartMassModifier
    {
        ...
        void AAMGuidance()
        {
            ...
            if (TargetAcquired)
            {
                ...
                {
                    DrawDebugLine(transform.position + (part.rb.velocity * Time.fixedDeltaTime), aamTarget, Color.blue);
                }
